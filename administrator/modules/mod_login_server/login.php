...
/**
 * Modified version of the default login screen for the administrator.
 *
...
<!-- START MODIFICATION OF THE ORIGINAL TEMPLATE -->
<jdoc:include type="module" name="mod_login_server" />
<!-- END MODIFICATION OF THE ORIGINAL TEMPLATE -->
